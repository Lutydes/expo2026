                ...
                <div className="flex items-start gap-4 p-4 bg-[#0a0f1d]/50 rounded-xl border border-[#a855f7]/10 hover:border-[#a855f7]/30 transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">
                        <strong className="text-[#a855f7]">Cursos:</strong> 3 a 5 pessoas da mesma turma, com papéis definidos
                        <br />
                        <strong className="text-[#a855f7]">Projeto Integrador:</strong> 10 a 12 alunos de todas as engenharias
                      </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-[#0a0f1d]/50 rounded-xl border border-[#a855f7]/10 hover:border-[#a855f7]/30 transition-colors">
                  ...
                  <div className="p-5 pt-0 border-t border-[#00f3ff]/10">
                    ...
                    <div className="mt-4 space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href="https://wa.me/5511949703282?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20o%20ExpoTech%202026!" target="_blank" rel="noopener noreferrer" className="text-[#00f3ff] hover:text-[#00d4e8] font-semibold">(11) 94970-3282</a>
                      </div>
                    </div>
                  </div>
                )}
